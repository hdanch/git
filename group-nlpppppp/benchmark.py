...
def featurize(corpus):
    ...
    tokenizer = TweetTokenizer(preserve_case=True, reduce_len=False, strip_handles=False).tokenize
    vectorizer = TfidfVectorizer(lowercase=True, strip_accents="unicode", analyzer="word", tokenizer=tokenizer, stop_words="english")
